...
{ 
     ...
     * Naziv prostorije
     *
     * @param int $id ID prostorije
     * @return string
     * @soap
     */
     public function getProstorijaNaziv($id)
     {
        return Prostorija::find()->where(['id' => $id])->one()->naziv;
     } 
     ...
     * @soap
     */
     public function getProstorije()
     {
        return Prostorija::find()->indexBy('id')->all();
     }
     ...
     * @soap
     */
     public function getProstorijePoNazivuIZgradi()
     {
        return Prostorija::find()->indexBy('naziv', 'zgrada')->all();
     }
